    ...
    <div className="min-h-screen bg-white text-[color:var(--ink)]">
      ...
      <section className="mx-auto max-w-3xl px-6 py-16 lg:py-24">
        ...
        <div className="mt-10 space-y-6 text-[15px] leading-relaxed text-[color:var(--ink)]/85">
          <p>These Terms of Service ("Terms") govern your access to and use of the Royal RoXn website and services. By accessing our site or engaging our services, you agree to these Terms.</p>

          <h2 className="font-display text-2xl font-bold text-[color:var(--ink)]">1. Services</h2>
          <p>Royal RoXn provides appointment-setting services for Canadian Realtors, including outbound prospecting, qualification, and calendar booking. Specific deliverables are outlined in your individual service agreement.</p>

          <h2 className="font-display text-2xl font-bold text-[color:var(--ink)]">2. Client Responsibilities</h2>
          ...
          <h2 className="font-display text-2xl font-bold text-[color:var(--ink)]">3. Fees and Payment</h2>
          <p>Fees are outlined in your service agreement. Invoices are due upon receipt unless otherwise stated. Late payments may result in service suspension.</p>

          <h2 className="font-display text-2xl font-bold text-[color:var(--ink)]">4. No Guarantee of Results</h2>
          <p>While we work diligently to deliver qualified appointments, we cannot guarantee specific outcomes, closings, or revenue. Results depend on many factors including market conditions and your follow-through.</p>

          <h2 className="font-display text-2xl font-bold text-[color:var(--ink)]">5. Intellectual Property</h2>
          <p>All content, branding, and materials on this website are the property of Royal RoXn and may not be reproduced without permission.</p>

          <h2 className="font-display text-2xl font-bold text-[color:var(--ink)]">6. Limitation of Liability</h2>
          <p>To the maximum extent permitted by law, Royal RoXn's total liability shall not exceed the amount paid by you for services in the three (3) months prior to the event giving rise to the claim.</p>

          <h2 className="font-display text-2xl font-bold text-[color:var(--ink)]">7. Termination</h2>
          <p>Either party may terminate the engagement in accordance with the terms of the service agreement. Certain provisions (including confidentiality and limitation of liability) survive termination.</p>

          <h2 className="font-display text-2xl font-bold text-[color:var(--ink)]">8. Governing Law</h2>
          <p>These Terms are governed by the laws of the Province of Ontario, Canada, and the federal laws of Canada applicable therein.</p>
