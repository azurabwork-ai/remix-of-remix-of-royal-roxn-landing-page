  ...
  head: () => ({
    meta: [
      { title: "Thank You - Royal RoXn" },
      {
        name: "description",
        content:
          "Thanks for booking your free strategy call with Royal RoXn. A Canadian strategist will reach out within one business day.",
      },
      ...
      <section className="relative overflow-hidden bg-white">
        ...
        <div className="mx-auto max-w-3xl px-6 py-20 text-center lg:py-28">
          ...
          <p className="mx-auto mt-5 max-w-xl text-base leading-relaxed text-[color:var(--muted-foreground)] sm:text-lg">
            Thank you for booking your free strategy call with Royal RoXn. A Canadian strategist
            will reach out within one business day to confirm your appointment.
          </p>
